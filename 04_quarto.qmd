...
| `fig-height: 8`  | Changes figure width in inches[^11_quarto-4]  |
| `fig-width: 8`   | Changes figure height in inches[^11_quarto-5] |

[^11_quarto-4]: The default dimensions for figures change based on the output format. Visit [here](https://quarto.org/docs/computations/execution-options.html#figure-options) to learn more.

[^11_quarto-5]: The default dimensions for figures change based on the output format. Visit [here](https://quarto.org/docs/computations/execution-options.html#figure-options) to learn more.
