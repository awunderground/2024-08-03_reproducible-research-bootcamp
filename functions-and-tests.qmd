...
- Definition: Fail loudly is the principle that errors should be difficult to ignore. In general, we will favor fatal errors that force us to address the underlying problem before proceeding.[^quarto]
...
Functions are the best way to follow the DRY principle. DRY, or **d**on't **r**epeat **y**ourself, is the principle that we should we should create a function any time we do something three times.
