...
Errors and mistakes are **inevitable**. We want to use systems that don't fail us as statisticians and data scientists. This is our gestalt moment like the famous duck-rabbit illusion in @fig-duck-rabbit.
...
Finally, we sort @tbl-tools into @tbl-roadmap, which outlines the structure of the rest of the day.
